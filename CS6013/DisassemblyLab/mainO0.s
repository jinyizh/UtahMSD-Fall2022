...
# -auxbase-strip mainO0.s -g -O0 -fverbose-asm
...
.LFB2:
	...
	movl	%edi, -4(%rbp)	# x, x
	movl	%esi, -8(%rbp)	# y, y
# main.cpp:4: 	return x + y;
	.loc 1 4 13
	movl	-4(%rbp), %edx	# x, tmp89
	movl	-8(%rbp), %eax	# y, tmp90
