...
import Items.Item;
import Rooms.Cell;
import Rooms.JaysCell;
import Rooms.JinyisCell;
import Rooms.Room;
...
public class Adventure {
    ...
    public static void main( String[] args ) {
        ...
        Room cell = new Cell();
        Room jinyisCell = new JinyisCell();
        Room jaysCell = new JaysCell();
        ...
        hall.addConnection(jaysCell);
        hall.addConnection(jinyisCell);
        ...
        System.out.println( "Welcome to Adventure 2022" );
